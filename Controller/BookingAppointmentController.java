...
public class BookingAppointmentController {
     ...
     public int insertBooking( int ID,String Dname,String Specilization,int Price,String Date,String PatientName){
         String insertQuery = String.format(
                 "insert into bookingappointment(AppointmentID, DoctorName, Specilization, price, Appointmentdate, PatientName, bookingstatus) values (%d,'%s','%s',%d,'%s','%s','%s')",ID,Dname,Specilization,Price,Date,PatientName,"Book");
     ...
     public int updateAppointment(String dname,String specilization,int price,String date,int id){
         String query=String.format("update bookingappointment set DoctorName='%s', Specilization='%s', price=%d, Appointmentdate='%s' where AppointmentID=%d",dname,specilization,price,date,id);
           dbConnection = new DbConnection();
